					...
					<div className="mx-auto grid grid-cols-1">
						<div className="flex justify-center items-center flex-col mb-5 space-y-10">
							...
							<div className="flex flex-col space-y-4">
								<Link
									href="/en"
									className="text-lg text-neutral-900 hover:text-neutral-800 text-center border-2 border-gray-800 rounded-xl px-6 py-3 transition-colors duration-200">
									Go to English Site
								</Link>
								<Link
									href="/id"
								...
								<button
									...
									className="text-lg text-neutral-600 hover:text-neutral-800 text-center border-2 border-gray-400 rounded-xl px-6 py-3 transition-colors duration-200">
									Go Back
								</button>
							</div>
						</div>
